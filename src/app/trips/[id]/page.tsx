    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-xl shadow overflow-hidden">
        ...
        {trip.expenses.length === 0 ? (
          ...
          <div key={e.id} className="grid grid-cols-7 gap-3 px-4 py-2 border-b last:border-0 text-sm">
      ...
      <div className="text-right text-sm">
        <span className="font-medium">Trip total:</span> ${total.toFixed(2)} {trip.expenses[0]?.currencyHome ?? "USD"}
      </div>
    </div>
  );
}
